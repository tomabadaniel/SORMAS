...
public class ImportFacadeEjb implements ImportFacade {
	...
	public void generateRegionImportTemplateFile() throws IOException {
		...
		List<String> columnNames = new ArrayList<>();
		List<String> entityNames = new ArrayList<>();
		appendListOfFields(columnNames, entityNames, RegionDto.class, "");
		Path filePath = Paths.get(getRegionImportTemplateFilePath());
	...
	public void generateDistrictImportTemplateFile() throws IOException {
		...
		List<String> columnNames = new ArrayList<>();
		List<String> entityNames = new ArrayList<>();
		appendListOfFields(columnNames, entityNames, DistrictDto.class, "");
		Path filePath = Paths.get(getDistrictImportTemplateFilePath());
		try (CSVWriter writer = CSVUtils.createCSVWriter(new FileWriter(filePath.toString()),
				configFacade.getCsvSeparator())) {
			writer.writeNext(columnNames.toArray(new String[columnNames.size()]));
			writer.flush();
	...
	public void generateCommunityImportTemplateFile() throws IOException {
		...
		List<String> columnNames = new ArrayList<>();
		List<String> entityNames = new ArrayList<>();
		appendListOfFields(columnNames, entityNames, CommunityDto.class, "");
		Path filePath = Paths.get(getCommunityImportTemplateFilePath());
		try (CSVWriter writer = CSVUtils.createCSVWriter(new FileWriter(filePath.toString()),
				configFacade.getCsvSeparator())) {
			writer.writeNext(columnNames.toArray(new String[columnNames.size()]));
			writer.flush();
	...
	public void generateFacilityLaboratoryImportTemplateFile() throws IOException {
		...
		List<String> columnNames = new ArrayList<>();
		List<String> entityNames = new ArrayList<>();
		appendListOfFields(columnNames, entityNames, FacilityDto.class, "");
		Path filePath = Paths.get(getFacilityLaboratoryImportTemplateFilePath());
		try (CSVWriter writer = CSVUtils.createCSVWriter(new FileWriter(filePath.toString()),
				configFacade.getCsvSeparator())) {
			writer.writeNext(columnNames.toArray(new String[columnNames.size()]));
			writer.flush();
